...
We created a model with dropped as response and everything else in our datas et as the explanatory variables.
...
```
This model has school, age, family size, past class failures, weekend drinking, attending nursery school and romantic partner as being statistically significant whether someone will drop out. This model has a degrees of freedom of 17 and AIC of 110.91 and RSS 110.91.
...
# Conclusion
-Grades are important (no shit) FIX THIS PLZ 

DONT CUSS YEAH

-SchoolMS kind of matters (more likely)
-Failures (obviously) (more likely)
-schoolsupyes (less likely)
-paidyes (less likely)
-romanticyes  (more likely)

Not signifcant:
The rest of the variables


It makes sense that if we are tracking grades throughout the semester, there will be a strong correlation
...
Investigate more students and expand study 

Look into other areas of the country

Issue: accuracy 

Variables are very subjective, not objective.

1-5 scale of very low to very high vs other numeric attributes 
